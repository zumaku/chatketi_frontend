...
export default function Chat() {
  ...
  return (
    <main className="container mx-auto flex justify-between items-center px-4">
      {/* PDF Viewer */}
      <div className="w-1/2">
      ...
      <div className="w-1/2 p-5 flex flex-col h-screen justify-start">
        {/* Chat */}
        ...
        <div className="flex flex-row w-full border border-gray-600 rounded-lg bg-white shadow-xl">
          <input
            type="text"
